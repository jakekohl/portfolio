...
var ue2 = (e = {}, t2, r, s4) => {
  if (t2) {
    let { variable: i2, options: a2 } = S.defaults || {}, { prefix: n, transform: l2 } = (e == null ? void 0 : e.options) || a2 || {}, o = z2(t2, k) ? t2 : `{${t2}}`;
...
function de(e, t2 = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      let h = m2[u], f2 = ve(h), p3 = z2(u, a2) ? Q2(d2) : Q2(d2, ee(u));
      if (i(f2)) o.push({ node: f2, path: p3 });
      else {
        let y2 = ae(p3), R2 = Y(f2, p3, s4, [a2]);
        Re(l2, y2, R2);
        let T2 = p3;
...
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s(a2) && n.transform !== "strict") {
    ...
    d2 = `${et}${tt2}`, u = [.../* @__PURE__ */ new Set([...We, ...Ze, ...Je])], h = m(a2.css, { dt: E2 });
  }
  ...
  if (s(t2) && r.transform !== "strict") {
    let y2 = e.replace("-directive", ""), m2 = t2, { colorScheme: R2, extend: T2, css: j2 } = m2, O2 = v3(m2, ["colorScheme", "extend", "css"]), d2 = T2 || {}, { colorScheme: M2 } = d2, z3 = v3(d2, ["colorScheme"]), u = R2 || {}, { dark: V } = u, L = v3(u, ["dark"]), h = M2 || {}, { dark: te } = h, re = v3(h, ["dark"]), K3 = s(O2) ? this._toVariables({ [y2]: g3(g3({}, O2), z3) }, r) : {}, A2 = s(L) ? this._toVariables({ [y2]: g3(g3({}, L), re) }, r) : {}, X = s(V) ? this._toVariables({ [y2]: g3(g3({}, V), te) }, r) : {}, [G2, U3] = [(f2 = K3.declarations) != null ? f2 : "", K3.tokens || []], [B, I] = [(x2 = A2.declarations) != null ? x2 : "", A2.tokens || []], [H, W2] = [(p3 = X.declarations) != null ? p3 : "", X.tokens || []], q2 = this.transformCSS(y2, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y2, H, "dark", "variable", r, i2, a2, n);
    l2 = `${q2}${Z}`, o = [.../* @__PURE__ */ new Set([...U3, ...I, ...W2])], c2 = m(j2, { dt: E2 });
  }
  ...
  let a2 = function(l2, o = {}, c2 = []) {
    ...
    if (typeof this.value == "string" && k.test(this.value)) {
      let u = this.value.trim().replace(k, (h) => {
        var y2;
        let f2 = h.slice(1, -1), x2 = this.tokens[f2];
    ...
    Object.entries(l2).forEach(([m2, d2]) => {
      let u = z2(m2, t2.variable.excludedKeyRegex) ? o : o ? `${o}.${oe2(m2)}` : oe2(m2), h = c2 ? `${c2}.${m2}` : m2;
      i(d2) ? n(d2, u, h) : (i2[u] || (i2[u] = { paths: [], computed: (f2, x2 = {}, p3 = []) => {
...
var S = { defaults: { variable: { prefix: "p", selector: ":root", excludedKeyRegex: /^(primitive|semantic|components|directives|variables|colorscheme|light|dark|common|root|states|extend|css)$/gi }, options: { prefix: "p", darkModeSelector: "system", cssLayer: false } }, _theme: void 0, _layerNames: /* @__PURE__ */ new Set(), _loadedStyleNames: /* @__PURE__ */ new Set(), _loadingStyles: /* @__PURE__ */ new Set(), _tokens: {}, update(e = {}) {
  let { theme: t2 } = e;
  t2 && (this._theme = $2(g3({}, t2), { options: g3(g3({}, this.defaults.options), t2.options) }), this._tokens = b2.createTokens(this.preset, this.defaults), this.clearLoadedStyleNames());
}, get theme() {
  return this._theme;
}, get preset() {
  var e;
  ...
  this._theme = $2(g3({}, this.theme), { preset: e }), this._tokens = b2.createTokens(e, this.defaults), this.clearLoadedStyleNames(), N2.emit("preset:change", e), N2.emit("theme:change", this.theme);
}, getOptions() {
  return this.options;
}, setOptions(e) {
  this._theme = $2(g3({}, this.theme), { options: e }), this.clearLoadedStyleNames(), N2.emit("options:change", e), N2.emit("theme:change", this.theme);
}, getLayerNames() {
  ...
  getStyleSheet: function getStyleSheet() {
    ...
    if (this.css) {
      ...
      var _props = Object.entries(props).reduce(function(acc, _ref2) {
        var _ref3 = _slicedToArray(_ref2, 2), k2 = _ref3[0], v4 = _ref3[1];
        return acc.push("".concat(k2, '="').concat(v4, '"')) && acc;
      }, []).join(" ");
  ...
  getThemeStyleSheet: function getThemeStyleSheet(params) {
    ...
    if (this.style) {
      ...
      var _props = Object.entries(props).reduce(function(acc, _ref4) {
        var _ref5 = _slicedToArray(_ref4, 2), k2 = _ref5[0], v4 = _ref5[1];
        return acc.push("".concat(k2, '="').concat(v4, '"')) && acc;
      }, []).join(" ");
...
//# sourceMappingURL=chunk-BMGM5HDT.js.map
