import {
  script as script2
} from "./chunk-KKZYIUVK.js";
import {
  Ripple
} from "./chunk-H742D3HN.js";
import {
  script as script3
} from "./chunk-GYCI624E.js";
import {
  script
} from "./chunk-YV76TYF2.js";
import {
  BaseStyle,
  a,
  f
} from "./chunk-BMGM5HDT.js";
import {
  createBaseVNode,
  createBlock,
  createCommentVNode,
...
var script5 = {
  ...
  computed: {
    ...
    dataP: function dataP() {
      return f(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2({}, this.size, this.size), "icon-only", this.hasIcon && !this.label && !this.badge), "loading", this.loading), "fluid", this.hasFluid), "rounded", this.rounded), "raised", this.raised), "outlined", this.outlined || this.variant === "outlined"), "text", this.text || this.variant === "text"), "link", this.link || this.variant === "link"), "vertical", (this.iconPos === "top" || this.iconPos === "bottom") && this.label));
    },
    dataIconP: function dataIconP() {
      return f(_defineProperty2(_defineProperty2({}, this.iconPos, this.iconPos), this.size, this.size));
    },
    dataLabelP: function dataLabelP() {
      return f(_defineProperty2(_defineProperty2({}, this.size, this.size), "icon-only", this.hasIcon && !this.label && !this.badge));
    }
  },
  components: {
    SpinnerIcon: script4,
...
//# sourceMappingURL=chunk-YFG2NDEK.js.map
