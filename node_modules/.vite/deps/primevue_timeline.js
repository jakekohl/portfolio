...
var script2 = {
  ...
  methods: {
    getKey: function getKey(item, index) {
      return this.dataKey ? c(item, this.dataKey) : index;
    },
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    return openBlock(), createElementBlock("div", mergeProps({
      ...
      item,
      index
    })], 16, _hoisted_3), createBaseVNode("div", mergeProps({
    ...
    }) : createCommentVNode("", true)], 16, _hoisted_4), createBaseVNode("div", mergeProps({
